...
<form action="<?php echo $_SERVER['PHP_SELF'];?>" method="POST" enctype="multipart/form-data"> 
 ...
 <div class="form-row form_img">
  ...
  <?php }else{?>
    <img src="images/<?php echo $val['profile_pic']?>" alt="enter image your profile" style="width: 20%;" id="image" >
    <?php }?>
 ...
 <div class="form-group">
  ...
  <div class="form-row">
    <div class="form-group col-md-6">
      ...
      <input type="text" class="form-control" id="email" name="email" value="<?php echo $val['email']?>"   required>
      <div id="message2">
